...
sgx_status_t say_something(sgx_enclave_id_t eid, sgx_status_t* retval, const uint8_t* some_string, size_t len)
{
	...
	ms.ms_some_string = (uint8_t*)some_string;
	ms.ms_len = len;
...
sgx_status_t say_something_twice(sgx_enclave_id_t eid, sgx_status_t* retval, const uint8_t* some_string, size_t len)
{
	sgx_status_t status;
	ms_say_something_twice_t ms;
	ms.ms_some_string = (uint8_t*)some_string;
	ms.ms_len = len;
